...
export default function LearnPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-50/50 text-slate-900 selection:bg-sky-100">
      {/* 背景のデザインアクセント */}
      <div className="pointer-events-none absolute inset-x-0 -top-40 h-96 bg-gradient-to-b from-sky-200/40 via-white to-transparent blur-3xl" />
      <div className="pointer-events-none absolute -right-20 top-60 h-80 w-80 rounded-full bg-emerald-100/40 blur-3xl" />
      <div className="pointer-events-none absolute -left-20 bottom-20 h-96 w-96 rounded-full bg-blue-100/30 blur-3xl" />

      <div className="relative mx-auto max-w-4xl px-6 py-12 fade-in">
        {/* ヘッダー：スッキリしたナビゲーション */}
        <header className="mb-12 flex items-center justify-between">
          <Link
            href="/"
            className="group flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-4 py-2 text-sm font-medium text-slate-600 backdrop-blur-sm transition-all hover:bg-white hover:shadow-sm active:scale-95"
          >
            <span className="transition-transform group-hover:-translate-x-1">←</span>
            ホームにもどる
          </Link>
          <div className="flex flex-col items-end">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-sky-500">Learning Center</span>
            <p className="text-xs text-slate-400">学ぶコーナー</p>
          </div>
        </header>

        {/* イントロダクション：安心感のあるメッセージボックス */}
        <section className="mb-12 rounded-3xl border border-white bg-white/40 p-8 backdrop-blur-md shadow-sm">
          <h1 className="text-2xl font-bold tracking-tight text-slate-800 md:text-3xl">
            いじめ・ストレスについて<br />
            <span className="text-sky-500">「少しだけ」</span>知っておく場所
          </h1>
          <div className="mt-6 space-y-4">
            ...
            <p className="inline-block rounded-lg bg-slate-100/80 px-3 py-2 text-[11px] leading-snug text-slate-500">
        ...
        <section className="space-y-4">
          <div className="mb-6 flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-slate-800">基礎編：いま、知っておきたいこと</h2>
          </div>

          <div className="grid gap-3">
            <Accordion title="🔵 自分がいじめられていると感じたら">
              <ul className="list-disc ml-4 space-y-2 py-2 text-sm leading-relaxed text-slate-600">
            ...
            <Accordion title="🟦 いじめについての基本">
              <ul className="list-disc ml-4 space-y-2 py-2 text-sm leading-relaxed text-slate-600">
                <li><b>言葉の攻撃</b>：悪口・からかい・あだ名付け など。</li>
                <li><b>排除</b>：無視・仲間外れ・グループから外す。</li>
                <li><b>ネット</b>：晒し・拡散・なりすまし・不適切画像の送受信。</li>
                <li><b>身体・物</b>：叩く・蹴る・物を壊す・隠す など。</li>
              </ul>
            </Accordion>
        ...
        <section className="mt-16 space-y-8">
          <div className="rounded-2xl bg-slate-900/5 p-8 backdrop-blur-sm">
            <h2 className="flex items-center gap-2 text-lg font-bold text-slate-900">
              <span className="text-xl">📚</span> 用語ミニ辞典
            </h2>
          ...
          <div className="space-y-4">
            <h3 className="flex items-center gap-2 pl-2 text-[11px] font-bold uppercase tracking-widest text-slate-400">
              <span className="h-px w-4 bg-slate-200" /> 🧠 メンタル・心の反応
            </h3>
            <div className="grid gap-3">
              <Accordion title="🧠 フラッシュバックとは？">
                <div className="space-y-3 py-2 text-sm leading-relaxed text-slate-600">
                  <p>
                  ...
                  <p className="rounded bg-white/50 p-2 text-xs">
          ...
          <div className="space-y-4">
            <h3 className="flex items-center gap-2 pl-2 text-[11px] font-bold uppercase tracking-widest text-slate-400">
              <span className="h-px w-4 bg-slate-200" /> ⚖️ いじめ・ハラスメント・ネットトラブル など
            </h3>
            <div className="grid gap-3">
          ...
          <div className="space-y-4">
            <h3 className="flex items-center gap-2 pl-2 text-[11px] font-bold uppercase tracking-widest text-slate-400">
              <span className="h-px w-4 bg-slate-200" /> 🏫 学校・人間関係
            </h3>
            <div className="grid gap-3">
          ...
          <div className="space-y-4">
            <h3 className="flex items-center gap-2 pl-2 text-[11px] font-bold uppercase tracking-widest text-slate-400">
              <span className="h-px w-4 bg-slate-200" /> 💻 ネット・SNS トラブル
            </h3>
            <div className="grid gap-3">
          ...
          <div className="space-y-4">
            <h3 className="flex items-center gap-2 pl-2 text-[11px] font-bold uppercase tracking-widest text-slate-400">
              <span className="h-px w-4 bg-slate-200" /> 🏠 家庭・ヤングケアラー
            </h3>
            <div className="grid gap-3">
          ...
          <div className="space-y-4 pb-12">
            <h3 className="flex items-center gap-2 pl-2 text-[11px] font-bold uppercase tracking-widest text-slate-400">
              <span className="h-px w-4 bg-slate-200" /> ⚖️ 法律・制度
            </h3>
            <div className="grid gap-3">
