    ...
    <main className="min-h-screen bg-[#FBFAF9] text-slate-800">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <header className="mb-10 flex items-center justify-between gap-4">
          ...
          <Link
            href="/counselor"
            className="inline-flex items-center gap-2 rounded-lg bg-slate-900 px-4 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-black"
          >
        ...
        <section className="mb-8 grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
          <div className="rounded-lg border border-slate-100 bg-white p-6 shadow-[0_20px_80px_rgba(15,23,42,0.05)] sm:p-8">
            ...
            <p className="mt-4 max-w-2xl text-sm font-medium leading-relaxed text-slate-500">
              今の状況や気持ちを少し書くと、合いそうな相談先を上から表示します。名前、住所、学校名、SNS IDなどは書かないでください。
            </p>
            ...
            <div className="mt-8 rounded-lg border border-slate-100 bg-slate-50 p-4">
              ...
              <textarea
                ...
                rows={4}
                className="w-full resize-none rounded-lg border border-slate-200 bg-white px-5 py-4 text-sm font-medium leading-relaxed text-slate-700 outline-none transition placeholder:text-slate-300 focus:border-emerald-200 focus:ring-4 focus:ring-emerald-50"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-bold leading-relaxed">
                      自分や誰かの命・身体に危険があるときは、110・119、近くの大人、学校、医療機関、24時間相談窓口へすぐ連絡してください。
                    </p>
                  </div>
                </div>
              </div>
          ...
          <aside className="rounded-lg border border-blue-100 bg-blue-50/60 p-6">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-white text-blue-500 shadow-sm">
          ...
          <div className="flex flex-wrap gap-2">
            {methodOptions.map((option) => (
              <button
                ...
                className={`rounded-lg px-5 py-2.5 text-xs font-black transition ${
                  method === option
            ...
            >
              <div className="mb-4 flex items-start justify-between gap-4">
                ...
                {resource.phone && (
                  <a
                    ...
                    className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-emerald-500 text-white shadow-lg shadow-emerald-100 transition hover:bg-emerald-600"
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {resource.phone && (
                  <a
                    href={`tel:${resource.phone.replace(/-/g, "")}`}
                    className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-5 py-3 text-xs font-black text-white shadow-lg shadow-emerald-100 transition hover:bg-emerald-600"
                  >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-lg bg-slate-50 px-5 py-3 text-xs font-black text-slate-600 transition hover:bg-slate-100"
                >
                  公式サイト
