...
const HOTLINES: Hotline[] = [
  {
    ...
    description: "いじめ・学校・友達など、子どもや保護者が24時間相談できる窓口。",
    phone: "0120-0-78310",
  ...
  },
  {
    id: "childline",
    name: "チャイルドライン",
    description: "18歳までの子ども専用の電話・チャット相談。どんな内容でもOKで、名前を言わなくても相談できます。",
    phone: "0120-99-7777",
    hours: "毎週月〜土 16:00〜21:00 / 通話料無料",
    target: "18歳までの子ども",
    methods: ["電話", "チャット"],
  ...
  },
  {
    id: "jinken-kodomo",
    name: "子どもの人権110番（法務省）",
    description: "いじめや虐待など、子どもの人権に関する相談を受け付ける窓口です。",
    phone: "0120-007-110",
  ...
  },
  {
    ...
    description: "差別・ハラスメント・ネット中傷など、さまざまな人権問題の相談ができる電話窓口です。",
    phone: "0570-003-110",
    hours: "平日 8:30〜17:15 / 通話料無料",
    target: "年齢問わず",
    methods: ["電話"],
  ...
  },
  {
    id: "yorisoi",
    name: "よりそいホットライン",
    description: "孤独感、家族のこと、性のこと、お金、仕事、こころの悩みなど、テーマを問わず24時間相談できる窓口です。",
    phone: "0120-279-338",
  ...
  },
  {
    id: "inochi",
    name: "いのちの電話（地域ごとの窓口）",
    description: "死にたい気持ち・生きづらさなどについて話を聞いてもらえる電話相談です。",
  ...
  },
  {
    id: "net-jinken",
    name: "インターネット人権相談窓口",
    description: "インターネット上の人権侵害について、Webフォームで相談できる窓口です。",
  ...
  },
  {
    ...
    description: "虐待かも、と思ったときに子ども本人・周囲の人が通報や相談ができる番号です。",
    phone: "189",
    hours: "24時間",
    target: "子ども・周囲の大人",
    methods: ["電話"],
  ...
  },
  {
    ...
    description: "性被害・性的な無理な要求・画像のことで困っている人のための相談窓口です。各都道府県などの支援センターを確認できます。",
    hours: "センターによって異なる",
